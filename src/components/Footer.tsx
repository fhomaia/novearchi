...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer id="contact" className="d-flex  text-white justify-content-between 100-vw align-items-center">
        ...
        <div className='d-flex flex-column gap-2'>
            <div className='text-white d-flex gap-2 align-items-center justify-content-end'>
                <a target="_blank" href="https://wa.me/553199790999?text=Olá!%20Gostaria%20de%20tirar%20dúvidas%20sobre%20os%20projetos."><img src={whatsapp} width="50"/></a>
